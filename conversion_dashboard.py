...
# Gebe jedem Input-Feld eine eindeutige ID
rate_A = st.number_input("Conversion Rate A (%)", min_value=0.0, max_value=100.0, value=5.0, step=0.1, key="rate_A_input")
rate_B = st.number_input("Conversion Rate B (%)", min_value=0.0, max_value=100.0, value=6.0, step=0.1, key="rate_B_input")
